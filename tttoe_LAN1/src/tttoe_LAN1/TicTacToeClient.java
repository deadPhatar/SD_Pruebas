    ...
    public void play() throws Exception {
        ...
        try {
            ...
            if (response.startsWith("WELCOME")) {
                ...
                URL gifx = getClass().getClassLoader().getResource("x.gif");
                URL gifo = getClass().getClassLoader().getResource("o.gif");
                
                icon = new ImageIcon(mark == 'X' ? gifx : gifo);
                opponentIcon  = new ImageIcon(mark == 'X' ? gifo : gifx);
